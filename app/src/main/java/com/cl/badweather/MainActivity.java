...
import com.cl.badweather.ui.AboutUsActivity;
import com.cl.badweather.ui.CommonlyUsedCityActivity;
import com.cl.badweather.ui.MapWeatherActivity;
import com.cl.badweather.ui.MoreAirActivity;
import com.cl.badweather.ui.MoreDailyActivity;
import com.cl.badweather.ui.MoreLifestyleActivity;
import com.cl.badweather.ui.SearchCityActivity;
import com.cl.badweather.ui.SettingActivity;
import com.cl.badweather.ui.WallPaperActivity;
import com.cl.badweather.ui.WarnActivity;
import com.cl.badweather.ui.WorldCityActivity;
import com.cl.badweather.utils.APKVersionInfoUtils;
import com.cl.badweather.utils.AppStartUpUtils;
...
public class MainActivity extends MvpActivity<WeatherContract.WeatherPresenter>
    ...
    private String city = null;//市 国控站点数据  用于请求空气质量
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
            if ((System.currentTimeMillis() - timeMillis) > 2000) {
                ToastUtils.showShortToast(context, "再按一次退出BadWeather");
