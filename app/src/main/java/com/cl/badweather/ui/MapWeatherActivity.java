...
import com.cl.badweather.adapter.SevenDailyAdapter;
import com.cl.badweather.adapter.TodayDetailAdapter;
...
import com.cl.badweather.bean.SunMoonResponse;
import com.cl.badweather.bean.TodayDetailBean;
import com.cl.badweather.contract.MapWeatherContract;
...
import com.cl.badweather.view.horizonview.HourlyForecastView;
import com.cl.badweather.view.horizonview.IndexHorizontalScrollView;
import com.cl.badweather.view.horizonview.ScrollWatched;
import com.cl.badweather.view.horizonview.ScrollWatcher;
import com.cl.badweather.view.skyview.SunView;
...
import static com.cl.badweather.utils.DateUtils.getNowDateNoLimiter;
import static com.cl.badweather.utils.DateUtils.updateTime;
...
public class MapWeatherActivity extends MvpActivity<MapWeatherContract.MapWeatherPresenter>
    ...
    private void initLocation() {
        ...
        if (mLocationClient != null){
            ...
            ToastUtils.showShortToast(context,"获取定位失败");
        }
    ...
    private OnGetGeoCoderResultListener onGetGeoCoderResultListener = new OnGetGeoCoderResultListener() {
        ...
        public void onGetReverseGeoCodeResult(ReverseGeoCodeResult reverseGeoCodeResult) {
            ...
            if (addressDetail.district == null) {
                ...
                if (addressDetail.district.equals("")){
                    addressDetail.district = addressDetail.city;
                    Log.d("address-->", addressDetail.province + addressDetail.city );
                    mPresent.searchCity(addressDetail.district);
                }
